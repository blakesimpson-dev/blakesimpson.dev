      ...
      <div class="splash">
        <div class="splash__header">
          <div class="splash-row">
            <div class="splash-item--one">
              <b>BS</b>
            </div>
            <div class="splash-item--two">
              <span>Developer</span>
            </div>
          </div>
          <div class="splash-row">
            <div class="splash-item--three">
              <span>Musician</span>
            </div>
          </div>
        </div>
        <div class="splash__footer">
          <span class="jp" >空調;自然に対する人間の勝利。</span>Air conditioning; Man's triumph over nature.
        </div>
      </div>
    </template>
    <template #content>
